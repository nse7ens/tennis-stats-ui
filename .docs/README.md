...
|---|---|---|
| [ADR](adr/README.md) | Developers / AI agents | Architecture Decision Records |
| [Specs](specs/README.md) | Developers / AI agents | Feature design specs |
| [Dev](dev/README.md) | Developers | Setup, architecture, data schema |
| [User guide](user/README.md) | End-users | How to use the app |
